...
void info() {
	cout << "Методы генерации равномерного распределения чисел:" << endl;
	cout << "	1 - Линейный конгруэнтный метод." << endl;
	cout << "	2 - Квадратичный конгруэнтный метод." << endl;
	cout << "	3 - Числа Фибоначчи." << endl;
	cout << "	4 - Обратная конгруэнтный последовательность." << endl;
	cout << "	5 - Метод объединения." << endl;
	cout << "Методы генерации нормального распределения чисел:" << endl;
	cout << "	6 - Правило \"3 сигма\"." << endl;
	cout << "	7 - Метод полярных координат." << endl;
	cout << "	8 - Метод соотношений." << endl;
	cout << "Методы генерации других распределений:" << endl;
	cout << "	9 - Метод логарифма для генерирования показательного распределения." << endl;
	cout << "	10 - Метод Аренса для генерации гамма-распределения порядка a>1." << endl;
	cout << "Введите число от 1 до 10, для выбора соответствующего метода." << endl;
}
